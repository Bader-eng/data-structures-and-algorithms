...
Write a function named sortByChildren that sorts the characters below by 
the number of children in each house (fewest to most). If a house has the 
same number of children, sort alphabetically by house name.
...
const sortByChildren = (charArray) => {
  charArray.sort((a,b) => {
      ...
      }else if (a.children.length=== b.children.length)
      {
        ...
        else if (a.house===b.house) return 0
      }
